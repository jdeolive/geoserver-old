...
public  class ManagerConfigPanelTest extends AbstractSecurityWicketTestSupport {
    ...
    public void testMangerConfigPanel() throws Exception {
        ...
        tester.assertModelValue(formComponentId+":config.configPasswordEncrypterName","configPasswordEncoder");
        ...
        form.setValue("config.configPasswordEncrypterName", "strongConfigPasswordEncoder");
