...
public class SimpleVersioningFeatureLocking extends VersioningFeatureLocking<SimpleFeatureType,SimpleFeature> 
    implements SimpleFeatureLocking {

    SimpleVersioningFeatureStore storeDelegate;
    
    public SimpleVersioningFeatureLocking(FeatureLocking<SimpleFeatureType,SimpleFeature> unversioned, VersioningDataStore store) {
        super(unversioned, store);
        storeDelegate = new SimpleVersioningFeatureStore((SimpleFeatureStore) unversioned, store);
    }
