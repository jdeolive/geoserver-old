...
//            SecurityManagerConfigImpl.class, "grantedAuthorityServiceName");
     ...
     */
    public void saveSecurityConfig(SecurityManagerConfig config) throws IOException {
        FileOutputStream fout = new FileOutputStream(new File(getSecurityRoot(), CONFIG_FILE_NAME));
        try {
